...
class TableViewController: UITableViewController {
    ...
    var namesArray = ["Erika", "Vanessa", "Meryl"]
    var subtitleArray = ["Talking about anxiety", "Talking about stress", "Talking about stress"]
...
/*
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "openChat", let _ = segue.destination as? ChatViewController {
        }
    }
 */
}
